                    ...
                    if(stopResponse) {
                        if (questionArrayList.get(questionCount).getCorrectOption().equalsIgnoreCase("A")) {
                            ...
                            try{
                                ...
                                AssetFileDescriptor afd = getAssets().openFd("a.mp3");
                                ...
                                Log.e("145145EE",e.toString());}
                        } else {

                            view.setBackgroundColor(Color.RED);
                            try{
                                MediaPlayer mp=new MediaPlayer();
                                AssetFileDescriptor afd = getAssets().openFd("wrong.mp3");
        ...
        if(questionCount != questionArrayList.size()){
            ...
            NotificationCompat.Builder mbuilder = (NotificationCompat.Builder)
                    new NotificationCompat.Builder(getApplicationContext())
                            .setSmallIcon(R.drawable.intro_logo2,10)
                            .setContentTitle("Quizopedia_Result")
                            .setContentText("You have scored -"+correctAnswers+"/"+questionArrayList.size());

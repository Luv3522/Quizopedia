...
public class AdminTopicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = "New Topic Added By Admin";
        String message = "You Have new Topic to Test Your Knowledge-->"+topic;
            ...
            public void onClick(View view) {
                addTopicToDatabase(topicEditText.getText().toString().trim());
                    ...
                    FcmNotificationsSender notificationsSender = new FcmNotificationsSender
                            ("/topics/all",title,message,getApplicationContext(),AdminTopicActivity.this);

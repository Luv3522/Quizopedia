...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    EditText optionAEditText,optionBEditText, optionCEditText, optionDEditText, questionEditText,explanationEditText,editTextTopic;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.addQuestionButton).setOnClickListener(view -> {
            if(arrayAdapterTopics.getCount() > 0){
                addQuestionToDb(editTextTopic.getText().toString(),
